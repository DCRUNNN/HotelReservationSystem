...
public class ModifyStrategyUI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ModifyStrategyUI frame = new ModifyStrategyUI();
	...
	public void init(){
		...
		button_Save.setFont(new Font("Î¢ÈíÑÅºÚ", Font.PLAIN, 24));
		button_Save.setBounds(540, 690, 149, 41);
		contentPane.add(button_Save);
		
		JButton button_Cancel = new JButton("\u53D6\u6D88");
		button_Cancel.setFont(new Font("Î¢ÈíÑÅºÚ", Font.PLAIN, 24));
		button_Cancel.setBounds(821, 690, 149, 41);
		contentPane.add(button_Cancel);
		
		JLabel strategyID = new JLabel("ID");
		strategyID.setFont(new Font("Î¢ÈíÑÅºÚ", Font.PLAIN, 22));
		strategyID.setBounds(544, 44, 119, 21);
		contentPane.add(strategyID);
	}
}
