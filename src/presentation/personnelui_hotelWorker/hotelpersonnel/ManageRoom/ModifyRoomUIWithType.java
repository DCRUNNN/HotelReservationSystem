...
public class ModifyRoomUIWithType extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ModifyRoomUIWithType frame = new ModifyRoomUIWithType();
...
//		panel.setOpaque(false);
		...
		textField_2.setBounds(150, 172, 192, 27);
