...
public class showExecutedHotelsUI extends JFrame
{
	 ...
	 * Create the frame.
	 */
	public showExecutedHotelsUI(CheckHistoryHotelUIController controller)
	{
		...
		*/
		...
		orderButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.orderButtonClicked_exe();
			}
		});
		...
		allHotelsButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.allButtonClicked_exe();
			}
		});
		...
		uneButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.uneButtonClicked_exe();
			}
		});
		...
		witButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.witButtonClicked_exe();
			}
		});
		...
		abnButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.abnButtonClicked_exe();
			}
		});
