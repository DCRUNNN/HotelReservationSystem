...
public class showAllHotelsUI extends JFrame
{
	 ...
	 * Create the frame.
	 */
	public showAllHotelsUI(CheckHistoryHotelUIController controller)
	{
		...
		*/
		...
		orderButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.orderButtonClicked_all();
			}
		});
		...
		exeButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent arg0)
			{
				controller.exeButtonClicked_all();
			}
		});
		...
		uneButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.uneButtonClicked_all();
			}
		});
		...
		witButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.witButtonClicked_all();
			}
		});
		...
		abnButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.abnButtonClicked_all();
			}
		});
