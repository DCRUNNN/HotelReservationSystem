...
public class showWithdrawnHotelsUI extends JFrame
{
	 ...
	 * Create the frame.
	 */
	public showWithdrawnHotelsUI(CheckHistoryHotelUIController controller)
	{
		...
		*/
		...
		orderButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.orderButtonClicked_wit();
			}
		});
		...
		allHotelsButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.allButtonClicked_wit();
			}
		});
		...
		exeButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent arg0)
			{
				controller.exeButtonClicked_wit();
			}
		});
		...
		uneButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.uneButtonClicked_wit();
			}
		});
		...
		abnButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.abnButtonClicked_wit();
			}
		});
