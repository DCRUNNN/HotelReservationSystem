...
public class showUnexecutedHotelsUI extends JFrame
{
	 ...
	 * Create the frame.
	 */
	public showUnexecutedHotelsUI(CheckHistoryHotelUIController controller)
	{
		...
		*/
		...
		orderButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.orderButtonClicked_une();
			}
		});
		...
		allHotelsButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.allButtonClicked_une();
			}
		});
		...
		exeButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent arg0)
			{
				controller.exeButtonClicked_une();
			}
		});
		...
		witButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.witButtonClicked_une();
			}
		});
		...
		abnButton.addActionListener(new ActionListener()
		{
			
			@Override
			public void actionPerformed(ActionEvent e)
			{
				controller.abnButtonClicked_une();
			}
		});
	...
	{
		showAbnormalHotelsUI showAbnormalHotelsView = new showAbnormalHotelsUI(controller);
		controller.setView(showAbnormalHotelsView);
		this.dispose();
	}
