...
public class showAllOrdersUI extends JFrame
{
	...
	private JButton abnormalButton;
	private JButton withdrawnButton;
	private JButton UnexecutedButton;
	private JButton executedButton;
	 ...
	 * Create the frame.
	 */
	public showAllOrdersUI(ManagePersonalOrder_clientControllerService controller)
	{
		...
		try
		{
			...
			int all_orders = exe_orders + unexe_orders + withdr_orders +abn_orders;
					
			currentPage = 1;
			totalPage=all_orders%9==0?all_orders/9:all_orders/9+1;
			if(totalPage == 0)
			{
				totalPage = 1;
			}
			...
			for(int i=0;i<withdr_orders;i++)
			{
				orderVO = list_withdrawnorderVO.get(i);
				String id = orderVO.getOrderID()+"/";
				orderID += id;
				count += 1;
			}
			
			for(int i=0;i<abn_orders;i++)
			{
				orderVO = list_abnormalorderVO.get(i);
				String id = orderVO.getOrderID()+"/";
				orderID += id;
				count += 1;
			}
		...
		*/
		...
		lastPageButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent arg0)
			{
				controller.lastPageButtonClicked_all();
			}
		});
		...
		nextPageButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.nextPageButtonClicked_all();
			}
		});
		
		button_3 = new JButton(new ImageIcon("myOrder.jpg"));
		button_3.setBounds(610, 100, 100, 30);
		...
		accountButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.accountButtonClicked_all();
			}
		});
		...
		hotelButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.hotelButtonClicked_all();
			}
		});
		...
		creditButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.creditButtonClicked_all();
			}
		});
		...
		memberButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.memberButtonClicked_all();
			}
		});
		...
		check_1 = new JButton(new ImageIcon("view2.jpg"));
		check_1.setBounds(1040, 205, 100, 45);
		backgroundPanel.add(check_1);
		
		check_2 = new JButton(new ImageIcon("view2.jpg"));
		check_2.setBounds(1040, 255, 100, 45);
		backgroundPanel.add(check_2);
		
		check_3 = new JButton(new ImageIcon("view2.jpg"));
		check_3.setBounds(1040, 305, 100, 45);
		backgroundPanel.add(check_3);
		
		check_4 = new JButton(new ImageIcon("view2.jpg"));
		check_4.setBounds(1040, 355, 100, 45);
		backgroundPanel.add(check_4);
		
		check_5 = new JButton(new ImageIcon("view2.jpg"));
		check_5.setBounds(1040, 405, 100, 45);
		backgroundPanel.add(check_5);
		
		check_6 = new JButton(new ImageIcon("view2.jpg"));
		check_6.setBounds(1040, 455, 100, 45);
		backgroundPanel.add(check_6);
		
		check_7 = new JButton(new ImageIcon("view2.jpg"));
		check_7.setBounds(1040, 505, 100, 45);
		backgroundPanel.add(check_7);
		
		check_8 = new JButton(new ImageIcon("view2.jpg"));
		check_8.setBounds(1040, 555, 100, 45);
		backgroundPanel.add(check_8);
		
		check_9 = new JButton(new ImageIcon("view2.jpg"));
		check_9.setBounds(1040, 605, 100, 45);
		backgroundPanel.add(check_9);
		
		abnormalButton = new JButton(new ImageIcon("abn.jpg"));
		abnormalButton.setBounds(1050, 100, 100, 30);
		backgroundPanel.add(abnormalButton);
		abnormalButton.addActionListener(new ActionListener()
		{
			
			@Override
			public void actionPerformed(ActionEvent e)
			{
				controller.abnormalOrdersButtonClicked_all();
			}
		});
		
		withdrawnButton = new JButton(new ImageIcon("wit.jpg"));
		withdrawnButton.setBounds(940, 100, 100, 30);
		backgroundPanel.add(withdrawnButton);
		withdrawnButton.addActionListener(new ActionListener()
		{
			
			@Override
			public void actionPerformed(ActionEvent e)
			{
				controller.withdrawnOrdersButtonClicked_all();
			}
		});
		
		UnexecutedButton = new JButton(new ImageIcon("une.jpg"));
		UnexecutedButton.setBounds(830, 100, 100, 30);
		backgroundPanel.add(UnexecutedButton);
		UnexecutedButton.addActionListener(new ActionListener()
		{
			
			@Override
			public void actionPerformed(ActionEvent e)
			{
				controller.unexecutedOrdersButtonClicked_all();
			}
		});
		
		executedButton = new JButton(new ImageIcon("exe.jpg"));
		executedButton.setBounds(720, 100, 100, 30);
		backgroundPanel.add(executedButton);
		executedButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.executedOrdersButtonClicked_all();
			}
		});
		...
		returnMainUIButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.returnMainUIButtonClicked_all();
			}
		});
		...
		try
		{
			if(!id_order1.equals(""))
			{
				...
				check_1.addActionListener(new ActionListener()
				{
					...
					public void actionPerformed(ActionEvent e)
					{
						controller.checkButton1Clicked_all();
					}
				});
			}
			else
			...
			if(!id_order2.equals(""))
			{
				...
				check_2.addActionListener(new ActionListener()
				{
					...
					public void actionPerformed(ActionEvent e)
					{
						controller.checkButton2Clicked_all();
					}
				});
			}
			else
			...
			if(!id_order3.equals(""))
			{
				...
				check_3.addActionListener(new ActionListener()
				{
					...
					public void actionPerformed(ActionEvent e)
					{
						controller.checkButton3Clicked_all();
					}
				});
			}
			else
			...
			if(!id_order4.equals(""))
			{
				...
				check_4.addActionListener(new ActionListener()
				{
					...
					public void actionPerformed(ActionEvent e)
					{
						controller.checkButton4Clicked_all();
					}
				});
			}
			else
			...
			if(!id_order5.equals(""))
			{
				...
				check_5.addActionListener(new ActionListener()
				{
					...
					public void actionPerformed(ActionEvent e)
					{
						controller.checkButton5Clicked_all();
					}
				});
			}
			else
			...
			if(!id_order6.equals(""))
			{
				...
				check_6.addActionListener(new ActionListener()
				{
					...
					public void actionPerformed(ActionEvent e)
					{
						controller.checkButton6Clicked_all();
					}
				});
			}
			else
			...
			if(!id_order7.equals(""))
			{
				...
				check_7.addActionListener(new ActionListener()
				{
					...
					public void actionPerformed(ActionEvent e)
					{
						controller.checkButton7Clicked_all();
					}
				});
			}
			else
			...
			if(!id_order8.equals(""))
			{
				...
				check_8.addActionListener(new ActionListener()
				{
					...
					public void actionPerformed(ActionEvent e)
					{
						controller.checkButton8Clicked_all();
					}
				});
			}
			else
			...
			if(!id_order9.equals(""))
			{
				...
				check_9.addActionListener(new ActionListener()
				{
					...
					public void actionPerformed(ActionEvent e)
					{
						controller.checkButton9Clicked_all();
					}
				});
			}
			else
	...
	public void lastPageButtonCliecked_all()
	{
		if(currentPage==1)
		{
	...
	public void withdranOrdersButtonClicked_all()
	{
