...
public class showUnexecutedOrdersUI extends JFrame
{
	...
	private JButton withdraw_1;
	private JButton withdraw_2;
	private JButton withdraw_3;
	private JButton withdraw_4;
	private JButton withdraw_5;
	private JButton withdraw_6;
	private JButton withdraw_7;
	private JButton withdraw_8;
	private JButton withdraw_9;
	 ...
	 * Create the frame.
	 */
	public showUnexecutedOrdersUI(ManagePersonalOrder_clientControllerService controller)
	{
		...
		try
		{
			...
			currentPage = 1;
			totalPage=unexe_orders%9==0?unexe_orders/9:unexe_orders/9+1;
			if(totalPage == 0)
			{
				totalPage = 1;
			}
			...
			for(int i=0;i<unexe_orders;i++)
			{
				orderVO = list_unexecutedorderVO.get(i);
		...
		*/
		...
		lastPageButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent arg0)
			{
				controller.lastPageButtonClicked_une();
			}
		});
		...
		nextPageButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.nextPageButtonClicked_une();
			}
		});
		...
		allOrderButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.allOrdersButtonClicked_unexecuted();
			}
		});
		...
		accountButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.accountButtonClicked_une();
			}
		});
		...
		hotelButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.hotelButtonClicked_une();
			}
		});
		...
		creditButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.creditButtonClicked_une();
			}
		});
		...
		memberButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.memberButtonClicked_une();
			}
		});
		...
		abnormalOrdersButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.abnormalOrdersButtonClicked_unexecuted();
			}
		});
		...
		withdrawnOrdersButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.withdrawnOrdersButtonClicked_unexecuted();
			}
		});
		...
		executedOrdersButton.addActionListener(new ActionListener()
		{
			
			@Override
			public void actionPerformed(ActionEvent e)
			{
				controller.executedOrdersButtonClicked_unexecuted();
			}
		});
		...
		withdraw_1 = new JButton(new ImageIcon("withdraw.jpg"));
		withdraw_1.setBounds(1095, 205, 55, 45);
		backgroundPanel.add(withdraw_1);
		
		withdraw_2 = new JButton(new ImageIcon("withdraw.jpg"));
		withdraw_2.setBounds(1095, 255, 55, 45);
		backgroundPanel.add(withdraw_2);
		
		withdraw_3 = new JButton(new ImageIcon("withdraw.jpg"));
		withdraw_3.setBounds(1095, 305, 55, 45);
		backgroundPanel.add(withdraw_3);
		
		withdraw_4 = new JButton(new ImageIcon("withdraw.jpg"));
		withdraw_4.setBounds(1095, 355, 55, 45);
		backgroundPanel.add(withdraw_4);
		
		withdraw_5 = new JButton(new ImageIcon("withdraw.jpg"));
		withdraw_5.setBounds(1095, 405, 55, 45);
		backgroundPanel.add(withdraw_5);
		
		withdraw_6 = new JButton(new ImageIcon("withdraw.jpg"));
		withdraw_6.setBounds(1095, 455, 55, 45);
		backgroundPanel.add(withdraw_6);
		
		withdraw_7 = new JButton(new ImageIcon("withdraw.jpg"));
		withdraw_7.setBounds(1095, 505, 55, 45);
		backgroundPanel.add(withdraw_7);
		
		withdraw_8 = new JButton(new ImageIcon("withdraw.jpg"));
		withdraw_8.setBounds(1095, 555, 55, 45);
		backgroundPanel.add(withdraw_8);
		
		withdraw_9 = new JButton(new ImageIcon("withdraw.jpg"));
		withdraw_9.setBounds(1095, 605, 55, 45);
		backgroundPanel.add(withdraw_9);
		...
		returnMainUIButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.returnMainUIButtonClicked_une();
			}
		});
		...
		try
		{
			if(!id_order1.equals(""))
			{
				...
				check_1.addActionListener(new ActionListener()
				{
					...
					public void actionPerformed(ActionEvent arg0)
					{
						controller.checkButton1Clicked_une();
					}
				});
				withdraw_1.addActionListener(new ActionListener()
				{
					...
					public void actionPerformed(ActionEvent e)
					{
						controller.withdrawButton1Clicked();
					}
				});
			}
			else
			...
			if(!id_order2.equals(""))
			{
				...
				check_2.addActionListener(new ActionListener()
				{
					...
					public void actionPerformed(ActionEvent arg0)
					{
						controller.checkButton2Clicked_une();
					}
				});
				withdraw_2.addActionListener(new ActionListener()
				{
					...
					public void actionPerformed(ActionEvent e)
					{
						controller.withdrawButton2Clicked();
					}
				});
			}
			else
			...
			if(!id_order3.equals(""))
			{
				...
				check_3.addActionListener(new ActionListener()
				{
					...
					public void actionPerformed(ActionEvent arg0)
					{
						controller.checkButton3Clicked_une();
					}
				});
				withdraw_3.addActionListener(new ActionListener()
				{
					...
					public void actionPerformed(ActionEvent e)
					{
						controller.withdrawButton3Clicked();
					}
				});
			}
			else
			...
			if(!id_order4.equals(""))
			{
				...
				check_4.addActionListener(new ActionListener()
				{
					...
					public void actionPerformed(ActionEvent arg0)
					{
						controller.checkButton4Clicked_une();
					}
				});
				withdraw_4.addActionListener(new ActionListener()
				{
					
					@Override
					public void actionPerformed(ActionEvent e)
					{
						controller.withdrawButton4Clicked();
					}
				});
			}
			else
			...
			if(!id_order5.equals(""))
			{
				...
				check_5.addActionListener(new ActionListener()
				{
					...
					public void actionPerformed(ActionEvent arg0)
					{
						controller.checkButton5Clicked_une();
					}
				});
				withdraw_5.addActionListener(new ActionListener()
				{
					
					@Override
					public void actionPerformed(ActionEvent e)
					{
						controller.withdrawButton5Clicked();
					}
				});
			}
			else
			...
			if(!id_order6.equals(""))
			{
				...
				check_6.addActionListener(new ActionListener()
				{
					...
					public void actionPerformed(ActionEvent arg0)
					{
						controller.checkButton6Clicked_une();
					}
				});
				withdraw_6.addActionListener(new ActionListener()
				{
					
					@Override
					public void actionPerformed(ActionEvent e)
					{
						controller.withdrawButton6Clicked();
					}
				});
			}
			else
			...
			if(!id_order7.equals(""))
			{
				...
				check_7.addActionListener(new ActionListener()
				{
					...
					public void actionPerformed(ActionEvent arg0)
					{
						controller.checkButton7Clicked_une();
					}
				});
				withdraw_7.addActionListener(new ActionListener()
				{
					
					@Override
					public void actionPerformed(ActionEvent e)
					{
						controller.withdrawButton7Clicked();
					}
				});
			}
			else
			...
			if(!id_order8.equals(""))
			{
				...
				check_8.addActionListener(new ActionListener()
				{
					...
					public void actionPerformed(ActionEvent arg0)
					{
						controller.checkButton8Clicked_une();
					}
				});
				withdraw_8.addActionListener(new ActionListener()
				{
					
					@Override
					public void actionPerformed(ActionEvent e)
					{
						controller.withdrawButton8Clicked();
					}
				});
			}
			else
			...
			if(!id_order9.equals(""))
			{
				...
				check_9.addActionListener(new ActionListener()
				{
					...
					public void actionPerformed(ActionEvent arg0)
					{
						controller.checkButton9Clicked_une();
					}
				});
				withdraw_9.addActionListener(new ActionListener()
				{
					
					@Override
					public void actionPerformed(ActionEvent e)
					{
						controller.withdrawButton9Clicked();
					}
				});
			}
			else
	...
	public void executeOrdersButtonClicked()
	{
		showExecutedOrdersUI showExecutedOrdersView = new showExecutedOrdersUI(controller);
		controller.setView(showExecutedOrdersView);
		this.dispose();
	}
	...
	public void witButton1Clicked()
	{
		try
		{
			controller.withdraw(clientID, id_order1);
	...
	public void witButton2Clicked() 
	{
		try
		{
			controller.withdraw(clientID, id_order2);
			successDialog dialog = new successDialog();
			dialog.setAlwaysOnTop(true);
			dialog.setVisible(true);
		} catch (RemoteException e)
	...
	public void witButton3Clicked()
	{
		try
		{
			controller.withdraw(clientID, id_order3);
			successDialog dialog = new successDialog();
			dialog.setAlwaysOnTop(true);
			dialog.setVisible(true);
		} catch (RemoteException e)
	...
	public void witButton4Clicked()
	{
		try
		{
			controller.withdraw(clientID, id_order4);
			successDialog dialog = new successDialog();
			dialog.setAlwaysOnTop(true);
			dialog.setVisible(true);
		} catch (RemoteException e)
	...
	public void witButton5Clicked()
	{
		try
		{
			controller.withdraw(clientID, id_order5);
			successDialog dialog = new successDialog();
			dialog.setAlwaysOnTop(true);
			dialog.setVisible(true);
		} catch (RemoteException e)
	...
	public void witButton6Clicked()
	{
		try
		{
			controller.withdraw(clientID, id_order6);
			successDialog dialog = new successDialog();
			dialog.setAlwaysOnTop(true);
			dialog.setVisible(true);
		} catch (RemoteException e)
	...
	public void witButton7Clicked()
	{
		try
		{
			controller.withdraw(clientID, id_order7);
			successDialog dialog = new successDialog();
			dialog.setAlwaysOnTop(true);
			dialog.setVisible(true);
		} catch (RemoteException e)
	...
	public void witButton8Clicked()
	{
		try
		{
			controller.withdraw(clientID, id_order8);
			successDialog dialog = new successDialog();
			dialog.setAlwaysOnTop(true);
			dialog.setVisible(true);
		} catch (RemoteException e)
	...
	public void witButton9Clicked()
	{
		try
		{
			controller.withdraw(clientID, id_order9);
			successDialog dialog = new successDialog();
			dialog.setAlwaysOnTop(true);
			dialog.setVisible(true);
		} catch (RemoteException e)
