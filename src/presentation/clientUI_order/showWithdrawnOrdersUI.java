...
public class showWithdrawnOrdersUI extends JFrame
{
	 ...
	 * Create the frame.
	 */
	public showWithdrawnOrdersUI(ManagePersonalOrder_clientControllerService controller)
	{
		...
		*/
		...
		lastPageButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent arg0)
			{
				controller.lastPageButtonClicked_wit();
			}
		});
		...
		nextPageButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.nextPageButtonClicked_wit();
			}
		});
		
		allOrdersButton = new JButton(new ImageIcon("myOrder.jpg"));
		allOrdersButton.setBounds(610, 100, 100, 30);
		...
		allOrdersButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.allOrdersButtonClicked_withdrawn();
			}
		});
		...
		accountButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.accountButtonClicked_wit();
			}
		});
		...
		hotelButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.hotelButtonClicked_wit();
			}
		});
		...
		creditButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.creditButtonClicked_wit();
			}
		});
		...
		memberButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.memberButtonClicked_wit();
			}
		});
		...
		abnormalButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.abnormalOrdersButtonClicked_withdrawn();
			}
		});
		...
		UnexecutedButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.unexecutedOrdersButtonClicked_withdrawn();
			}
		});
		...
		executedButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.executedOrdersButtonClicked_withdrawn();
			}
		});
		...
		returnMainUIButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				controller.returnMainUIButtonClicked_wit();
			}
		});
		...
		try
		{
			if(!id_order1.equals(""))
			{
				...
				check_1.addActionListener(new ActionListener()
				{
					...
					public void actionPerformed(ActionEvent e)
					{
						controller.checkButton1Clicked_wit();
					}
				});
			}
			else
			...
			if(!id_order2.equals(""))
			{
				...
				check_2.addActionListener(new ActionListener()
				{
					...
					public void actionPerformed(ActionEvent e)
					{
						controller.checkButton2Clicked_wit();
					}
				});
			}
			else
			...
			if(!id_order3.equals(""))
			{
				...
				check_3.addActionListener(new ActionListener()
				{
					...
					public void actionPerformed(ActionEvent e)
					{
						controller.checkButton3Clicked_wit();
					}
				});
			}
			else
			...
			if(!id_order4.equals(""))
			{
				...
				check_4.addActionListener(new ActionListener()
				{
					...
					public void actionPerformed(ActionEvent e)
					{
						controller.checkButton4Clicked_wit();
					}
				});
			}
			else
			...
			if(!id_order5.equals(""))
			{
				...
				check_5.addActionListener(new ActionListener()
				{
					...
					public void actionPerformed(ActionEvent e)
					{
						controller.checkButton5Clicked_wit();
					}
				});
			}
			else
			...
			if(!id_order6.equals(""))
			{
				...
				check_6.addActionListener(new ActionListener()
				{
					...
					public void actionPerformed(ActionEvent e)
					{
						controller.checkButton6Clicked_wit();
					}
				});
			}
			else
			...
			if(!id_order7.equals(""))
			{
				...
				check_7.addActionListener(new ActionListener()
				{
					...
					public void actionPerformed(ActionEvent e)
					{
						controller.checkButton7Clicked_wit();
					}
				});
			}
			else
			...
			if(!id_order8.equals(""))
			{
				...
				check_8.addActionListener(new ActionListener()
				{
					...
					public void actionPerformed(ActionEvent e)
					{
						controller.checkButton8Clicked_wit();
					}
				});
			}
			else
			...
			if(!id_order9.equals(""))
			{
				...
				check_9.addActionListener(new ActionListener()
				{
					...
					public void actionPerformed(ActionEvent e)
					{
						controller.checkButton9Clicked_wit();
					}
				});
			}
			else
	...
	public void executedOrdersButtonClicked()
	{
		showExecutedOrdersUI showExecutedOrdersView = new showExecutedOrdersUI(controller);
		controller.setView(showExecutedOrdersView);
		this.dispose();
